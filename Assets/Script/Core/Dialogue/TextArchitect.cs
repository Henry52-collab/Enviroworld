...
public class TextArchitect 
{
    ...
    public int charactersPerCycle { get { return speedMultiplier <= 2f ? characteMultiplier : speedMultiplier <= 2.5f ? characteMultiplier * 2 : characteMultiplier * 3; } }

    public bool hurryUp = false;
    public int characteMultiplier = 1;
    ...
    private IEnumerator Build_Fade()
    {
        ...
        while (true)
        {
            float fadeSpeed = charactersPerCycle;
            ...
            if (alphas[maxRange - 1]>alphaThreshhold || lastCharacterIsInvisible)
            {
